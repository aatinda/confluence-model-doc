"""
This version of process model attempts to tranverse through the model hierarchy from the uml:Model
element then recursively through all the packagedElement.

Through the traversal the parent -> child hierarchy is preserved and an appropriate directory 
structure and markdown pages for each namespace, package, class, enumeration and data type.
